package com.milleniumcare.claims.objectmother;
...
public class ClaimMother {
    ...
    public static ClaimDrug.ClaimDrugBuilder claimDrug() {
        return ClaimDrug.builder()
                .claimNumber("DRG-101010101")
                .claimDate(LocalDate.now())
                .paymentDate(LocalDate.now().plusDays(10L))
