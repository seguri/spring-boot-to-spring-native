...
public class Member {
    ...
    private Collection<PrecertificationRequest> precertificationRequests;
    ...
    @OneToMany(mappedBy = "member")
    @JsonIgnore
    public Collection<PrecertificationRequest> getPrecertificationRequests() {
        return precertificationRequests;
    }

    public void setPrecertificationRequests(Collection<PrecertificationRequest> precertificationRequests) {
        this.precertificationRequests = precertificationRequests;
    }
}
